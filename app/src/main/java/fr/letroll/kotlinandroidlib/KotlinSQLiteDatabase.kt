...
public fun SQLiteDatabase.queryWithFactory<T>(cursorFactory: CursorFactory?, distinct: Boolean, table: String?,
...
public fun SQLiteDatabase.query<T>(table: String?, columns: Array<String>?, selection: String?,
...
public fun SQLiteDatabase.rawQuery<T>(sql: String?, selectionArgs: Array<String>?, create: Cursor.() -> T): MutableCollection<T> {
    return rawQuery(sql, selectionArgs).mapAndClose(create)
}

public fun SQLiteDatabase.rawQueryWithFactory<T>(cursorFactory: CursorFactory?, sql: String?, selectionArgs: Array<String>?,
...
public fun SQLiteDatabase.insert(table: String?, nullColumnHack: String?, create: ContentValues.() -> Unit): Long {
    val values = ContentValues()
    values.create()
    return insert(table, nullColumnHack, values)
}

public fun SQLiteDatabase.insertOrThrow(table: String?, nullColumnHack: String?, create: ContentValues.() -> Unit): Long {
    val values = ContentValues()
    values.create()
    return insertOrThrow(table, nullColumnHack, values)
}

public fun SQLiteDatabase.insertWithOnConflict(table: String?, nullColumnHack: String?, conflictAlgorithm: Int, create: ContentValues.() -> Unit): Long {
    val values = ContentValues()
    values.create()
    return insertWithOnConflict(table, nullColumnHack, values, conflictAlgorithm)
}

public fun SQLiteDatabase.update(table: String?, whereClause: String?, whereArgs: Array<String>?, create: ContentValues.() -> Unit): Int {
    val values = ContentValues()
    values.create()
    return update(table, values, whereClause, whereArgs)
}

public fun SQLiteDatabase.updateWithOnConflict(table: String?, whereClause: String?, whereArgs: Array<String>?, conflictAlgorithm: Int, create: ContentValues.() -> Unit): Int {
    val values = ContentValues()
    values.create()
